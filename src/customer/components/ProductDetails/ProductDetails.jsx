  ...
  return (
    <div className="bg-white lg:px-20  ">
      <div className="pt-6">
                ...
                <div className="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <div className="mt-6">
                        <div className="flex items-center space-x-3">
                            <Rating name="read-only" value={2.7} readOnly />
                            <p className='text-sm' >12 Ratings</p>
                            <p href={reviews.href} className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-200">
        ...
        {/* {rating and reviews} */}
        <section>
          <h1 className='text-lg font-bold' >Recent Review & Rating</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5} >
                ...
                <div className='flex items-center space-x-3' >
                  ...
                  <p className='opacity-50' > 12 Ratings</p>
                </div>
                <Box className='mt-5  space-y-3' >
                  <Grid container  alignItems="center" gap={2}  >
                    ...
                    <Grid item xs={7} >
                      <LinearProgress sx={{borderRadius:4,height:7}}  variant="determinate"  value={40} color="success"  />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container  alignItems="center" gap={2}  >
                    ...
                    <Grid item xs={7} >
                      <LinearProgress sx={{borderRadius:4,height:7}}  variant="determinate"  value={40} color="primary"  />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container  alignItems="center" gap={2}  >
                    ...
                    <Grid item xs={7} >
                      <LinearProgress sx={{borderRadius:4,height:7}}  variant="determinate"  value={40} color="warning"  />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container  alignItems="center" gap={2}  >
                    ...
                    <Grid item xs={7} >
                      <LinearProgress sx={{borderRadius:4,height:7}}  variant="determinate"  value={40} color="error"  />
                    </Grid>
                  </Grid>
        ...
        <section className='pt-10'  >
          <h1 className='text-lg' >Similar products</h1>
          <div className='flex flex-wrap space-y-5 ' >
            {iphones.map((item)=><HomeSectionCard product={item} /> )}
          </div>
        </section>
      </div>
    </div>
